...
public abstract class DateUtil {
     ...
     *
     * @param pattern
     * @param stringDate yyyyMMdd 格式字符串
     * @return
     */
     ...
     * @return
     */
    public static Date parse(final String pattern, final String strDateTime, Locale locale) {
     ...
     *
     * @param String sDate, boolean startDay
     * @return Date
     */
     ...
     *
     * @param String sDate, String hour,String minute,String second
     * @return Date
     */
    ...
    /**
     * YYYYMMDDHISS格式变成 YYYY-MM-DD HH:MM:SS
     *
     * @param str
     * @return
     */
    public static String stringToFullDate(String str) {
        try {
            String year = str.substring(0, 4);
            String moth = str.substring(4, 6);
            String day = str.substring(6, 8);
            ...
            String date = year + "-" + moth + "-" + day + " " + hour + ":" + minute + ":" + second;
            return date;
        } catch (Exception e) {
            return null;
        }
     ...
     * 返回制定日期前后多少分钟的时间
     *
     * @param curDatetime yyyyMMddHHmmss
     * @param minutes分钟
    ...
    public static String getDatetimeByMinutes(String curDatetime, int minutes) {
        try {
            ...
            Date theDate = formatter.parse(curDatetime);
     ...
     * 开始日期是否大于结束日期
     *
     * @param beginDate yyyy-MM-dd hh:mi:ss
     * @param endDate   yyyy-MM-dd hh:mi:ss
     * @return
     */
     ...
     * @return
     */
    public static boolean isgreaterForDate3(String beginDate, String endDate) {
        try {

            Date d_beginDate = DATEFORMAT.parse(beginDate);
            Date d_endDate = DATEFORMAT.parse(endDate);
...
//	System.out.println(DateUtil.isgreaterForDate3("20130718", "20130719")); //false
//	System.out.println(DateUtil.isgreaterForDate3("20130718", "20130717")); //true
//	System.out.println(DateUtil.isgreaterForDate3("20130718", "20130718")); //false
//	System.out.println(DateUtil.getNowDay()); //false
//	System.out.println(DateUtil.formatDateTime(DateUtil.DF_YMD, DateUtil.operateDate(DateUtil.getNewDate(), -1)));
        System.out.println(DateUtil.operateMonth(DateUtil.getNewDate(), 0)); //false
        System.out.println(DateUtil.operateMonth(DateUtil.getNewDate(), 1)); //false
        System.out.println(DateUtil.operateMonth(DateUtil.getNewDate(), -1)); //false
    }
     ...
     * @return
     */
    public static Date operateMonth(Date date, Integer i) {
        Calendar cd = Calendar.getInstance();
        cd.setTime(date);
